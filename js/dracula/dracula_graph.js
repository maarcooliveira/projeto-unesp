...
AbstractEdge.prototype = {
    ...
    remove: function() {
        this.connection.fg.remove();
        this.connection.label.remove();
    }
};
...
Graph.Renderer.Raphael.prototype = {
    ...
    drawNode: function(node) {
        ...
        if(node.shape && typeof node.shape.getBBox === "function") {
    ...
    drawEdge: function(edge) {
        ...
        // edge.connection.fg.click(function() {
        //     console.log("click from graph.js, 338");
        // });
    }
};
Graph.Layout = {};
...
Graph.Layout.Grid = function(graph, isAssigned) {
   this.graph = graph;
...
Graph.Layout.Grid.prototype = {
   ...
   layoutCalcBounds: function() {
      ...
      // TODO: mudança é provisória para não cortar obj. no grid
      this.graph.layoutMinX = minx - 0.25;
      this.graph.layoutMaxX = maxx + 0.25;

      this.graph.layoutMinY = miny;
      this.graph.layoutMaxY = maxy;

      console.log(maxx);
      console.log(this.graph.layoutMaxX);
   }
};
